<?php
    ...
    if(($_POST['name']) == ""){
        echo "<script>alert ('Digite um nome para consulta!');</script>";
...
<html>
    ...
    <body onload="history.go(+1)">
        ...
        <div class="row margin marginTop">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="panel panel-primary pad">
                    <h2 class="text-muted index">Funcionários Cadastrados</h2>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-6 col-md-10 col-md-offset-1 col-lg-10 col-md-offset-1">
                ...
                <tr>
                    <?php
                        ...
                        if(isset($_POST['name'])){
                            $nconsult = ucwords(strtolower($_POST['name']));
                        }
                        $cont = 0;        
                        while($row = mysqli_fetch_assoc($result)){
                            if($nconsult == $row['NOME']){
                ?>
                    <td>
                        <?php echo "".$row['NOME'];?>
                    </td>
                ...
                <?php  
                    ...
                    if($cont == 0){
                        echo "<script>alert ('Sua consulta não retornou nenhum resultado!');</script>";
                        echo "<script>window.location = 'consultar.php';</script>";
                        } 
        ...
        <div class="row margin">
            <div class="col-xs-6 col-md-8 col-md-offset-2 col-lg-8 col-md-offset-2">
                <a href="consultar.php" type="button" class="btn btn-warning">Voltar</a>
            </div>
        </div>
