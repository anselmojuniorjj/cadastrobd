        ...
        <div class="row margin marginTop">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="panel panel-primary pad">
                    <h2 class="text-muted index">Alterar Dados</h2>
                </div>
            </div>
        </div>
                ...
                <form action="alterar.php" method="post">
                    <div class="width">
                        <?php
                            ...
                            $sql = "SELECT NOME, SOBRENOME, CARGO, IDADE, TELEFONE FROM rm WHERE RM=".$rm;
                        ...
                        <fieldset> 
                            ...
                            <p>Nome :</p>
                            <p><input type="text" name="nome" size="20" value="<?php echo "".$row['NOME'];?>"></p>
                            <p>Sobrenome :</p>
                            <p><input type="text" name="snome" size="30" value="<?php echo "".$row['SOBRENOME'];?>"></p>
                            <p>Cargo :</p>
                            <p><input type="text" name="cargo" size="20" value="<?php echo "".$row['CARGO'];?>"></p>
                            <p>Idade :</p>
                            <p><input type="number" name="idade" value="<?php echo "".$row['IDADE'];?>"></p>
                            <p>Telefone :</p>
                            <p><input type="number" name="tel" value="<?php echo "".$row['TELEFONE'];?>"></p>
                            <div>
                                <input type="button" value="Cancelar" class="btn btn-warning" onclick="cancelar()">
